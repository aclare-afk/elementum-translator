...
- **Persistence**: writes are in-memory per Vercel function instance. Cold starts reset the data. This is great for "push this incident, see it appear" demos — don't promise it survives overnight.
